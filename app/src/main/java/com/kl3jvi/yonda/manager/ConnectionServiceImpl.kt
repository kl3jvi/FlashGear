...
//        data object Start : ScanCommand()
//        data object Stop : ScanCommand()
//    }
//
...
//    }
//
//    override fun scanBleDevices(): Flow<DiscoveredBluetoothDevice> = callbackFlow {
...
//                trySend(DiscoveredBluetoothDevice(result.device, result.rssi)).isSuccess
//            }
//
...
//                trySend(DiscoveredBluetoothDevice(errorCode = errorCode)).isSuccess
//            }
//        }
//
//        val job = launch {
